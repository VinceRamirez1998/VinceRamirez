  ...
  const tabs = [
    { name: 'Experience', content: (
      <>
        ...
        <div>
          <h3 className="text-lg font-medium">Alliance Health Care</h3>
          <p className="italic">Full Stack Web Developer - E-commerce, WordPress, Elementor</p>
          <p className="text-gray-600">Mexico, Pampanga | June 2024 - Current</p>
        ...
        <div className="mt-6">
          ...
          <p className="italic">Full Stack Web Developer - DMS: Laravel, PHP, Tailwind</p>
          <p className="text-gray-600">Clark, Pampanga | March 2022 - May 2024</p>
          <ul className="list-disc pl-5 mt-2">
        ...
        <div className="mt-6">
          <h3 className="text-lg font-medium">Offsure Outsourcing Global Inc.</h3>
          <p className="italic">Full Stack Web Developer - Internship - AMS</p>
          <p className="text-gray-600">Clark, Pampanga | Feb 2024 - May 2024</p>
          <ul className="list-disc pl-5 mt-2">
        ...
        <div className="mt-6">
          <h3 className="text-lg font-medium">Capstone Project</h3>
          <p className="italic">Lead Programmer - Recruitment Government Platform</p>
          <p className="text-gray-600">Mexico, Pampanga | Aug 2022 - Dec 2023</p>
          <ul className="list-disc pl-5 mt-2">
    ...
    <section className="py-6 px-6 bg-white dark:bg-darkbg">
      <div className="min-h-screen flex justify-center">
        <div className="max-w-screen-xl w-customwidth mt-10">
          ...
          {/* Tab Content */}
          <div
            className={`p-4 rounded-lg bg-white text-gray-700 ${activeTab ? 'dark:bg-gray-800 dark:text-gray-300' : ''}`}
          >
            {tabs.map(
              (tab) =>
                activeTab === tab.name && (
